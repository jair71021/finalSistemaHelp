      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            <a style="color:orange" class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a style="color:success" class="dropdown-item" href="#"
                data-toggle="modal" data-target="#modalActualizarDatosPersonales"
                onclick="obtenerDatosPersonalesInicio(<?php 
                            echo $_SESSION['usuario']['id'];?>)">Ediatr Datos </a>
              <div class="dropdown-divider"></div>
              <a  style="color:red" class="dropdown-item" href="../procesos/usuarios/login/salir.php">Salir</a>
