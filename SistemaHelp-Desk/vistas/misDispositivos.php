              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="card">
                    <div class="card-body">
                      <h3>
                        <span class="<?php echo $ver['imagen']; ?>"></span>
                        <?php echo $ver['nombreEquipo']; ?>
                      </h3>
                        <p><?php echo $ver['descripcion']; ?></p>
                          <ul>
                            <li>Marca:      <?php echo $ver['marca']; ?></li>
                            <li>Modelo:     <?php echo $ver['modelo']; ?></li>
                            <li>Color:      <?php echo $ver['color']; ?></li>
                            <li>Memoria:    <?php echo $ver['memoria']; ?></li>
                            <li>Disco Duro: <?php echo $ver['discoDuro']; ?></li>
                            <li>Procesador: <?php echo $ver['procesador']; ?></li>
                          </ul>
                    </div>
                  </div>
                </div>
